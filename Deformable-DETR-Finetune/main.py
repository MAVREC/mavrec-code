...
def get_args_parser():
    ...
    parser.add_argument('--finetune', default=False, help='finetune on resumed checkpoint')
...
def main(args):
    ...
    if args.resume:
        ...
        if not args.eval and 'optimizer' in checkpoint and 'lr_scheduler' in checkpoint and 'epoch' in checkpoint and not args.finetune: # not used when finetuning
            import copy
